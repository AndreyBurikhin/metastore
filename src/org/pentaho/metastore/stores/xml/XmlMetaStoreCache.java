...
public interface XmlMetaStoreCache {
   ...
   * @param elementId
   */
  void registerElementTypeIdForName( String namespace, String elementTypeName, String elementId );
  ...
  XmlMetaStoreCache NO_CACHE_INSTANCE = new XmlMetaStoreCache() {
    ...
    @Override
    public void registerElementTypeIdForName( String namespace, String elementTypeName, String elementId ) {
    }
